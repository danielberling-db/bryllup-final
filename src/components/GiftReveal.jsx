...
const GiftReveal = () => {
  return (
    <section id="gift-section" className="relative w-full m-0 flex flex-col items-center justify-center py-12 md:py-32 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-[#FFF5F0] to-[#FFFFFF] overflow-hidden">
