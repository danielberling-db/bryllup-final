...
const GiftReveal = () => {
  return (
    <section id="gift-section" className="relative w-full m-0 flex flex-col items-center justify-center pt-24 md:pt-32 pb-12 md:pb-32 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-[#FFF5F0] to-[#FFFFFF] overflow-visible">
