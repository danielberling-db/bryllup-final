...
const Logistics = () => {
  ...
  return (
    <section id="logistics-section" className="w-full max-w-full m-0 flex flex-col items-center justify-center py-12 md:py-32 px-4 sm:px-6 bg-transparent overflow-x-hidden">
