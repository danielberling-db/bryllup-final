...
const Intro = () => {
  ...
  return (
    <section className="relative w-full max-w-full m-0 flex flex-col items-center justify-center py-12 md:py-32 bg-gradient-to-b from-[#F2E8DA] to-[#EBC7C7] overflow-hidden">
