...
const Timeline = () => {
  ...
  return (
    <section id="timeline-section" className="relative w-full max-w-full m-0 flex flex-col items-center justify-center py-12 md:py-32 bg-gradient-to-b from-[#EBC7C7] to-[#F9B89B] overflow-hidden">
