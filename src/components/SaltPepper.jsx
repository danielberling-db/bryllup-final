...
const SaltPepper = () => {
  ...
  return (
    <section className="relative w-full m-0 flex flex-col items-center justify-center pt-4 pb-12 md:py-32 px-4 sm:px-6 bg-gradient-to-b from-[#EBC7C7] to-[#EBC7C7] overflow-hidden">
