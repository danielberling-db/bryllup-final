  ...
  return (
    <ReactLenis root>
      ...
      >
        ...
        <nav className="fixed top-0 left-0 w-full z-50 px-5 md:px-8 pt-5 md:pt-5 pb-3 md:pb-4 transition-all duration-300 backdrop-blur-md border-b border-antique-gold/20" style={{
           ...
           <div className="flex justify-between w-full items-center">
             <div className="flex items-center flex-shrink-0 z-10">
               <a
                 ...
                 className="bg-gradient-to-r from-antique-gold to-[#FCF6BA] text-white px-6 md:px-8 py-3.5 md:py-4 rounded-full font-semibold shadow-lg marshmallow-transform font-cinzel text-sm md:text-base whitespace-nowrap flex flex-col items-center leading-tight"
               >
                 <span>SVAR</span>
             ...
             <div className="flex items-center justify-end flex-shrink-0 z-10">
               <button
                 ...
                 className="p-4 md:p-5 text-deep-charcoal hover:text-antique-gold marshmallow-transform flex items-center justify-center"
